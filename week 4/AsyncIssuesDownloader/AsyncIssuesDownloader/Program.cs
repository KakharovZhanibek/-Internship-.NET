...
";
        ...
        static async Task Main(string[] args)
        {
            ...
            "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");
        ...
        private static async IAsyncEnumerable<JObject> RunPagedQueryAsync(GitHubClient client, string queryText, string repoName, CancellationToken cancel, IProgress<int> progress)
        {
